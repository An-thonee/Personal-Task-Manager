    ...
    <section className="mt-10 px-35">
      ...
      <form action="" className="flex flex-col gap-8">
        <div className="relative border border-gray-300 rounded px-5 pt-6 pb-4">
          ...
          <p className="w-full text-start text-[#292929]">Project Completion</p>
        </div>
        <div className="relative border border-gray-300 rounded px-5 pt-6 pb-4">
          ...
          <p className="h-30 w-full text-start text-[#292929]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra sit
            in aliquam pretium. Diam consectetur at tincidunt sed non tempus
            faucibus posuere eu. Nisi, luctus turpis pharetra quis nunc nulla.
            At lectus faucibus mattis ante eleifend ac arcu. Nibh morbi
        ...
        <Link to="/mytask">
          <button
            type="submit"
            className="w-full rounded bg-[#974FD0] py-4 text-xl font-bold text-white hover:bg-purple-600"
          >
            Done
          </button>
        </Link>
